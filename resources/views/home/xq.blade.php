                ...
                <div class="span8 J_mi_goodsPic_block">
                    <div id="J_mi_goodsPicBox" class="goods-pic-box ">
                        <div style="margin: 20px 0 10px; width: 430px;height: 410px;">
                            <a rel="gal1" href="/public/demo/goods/20190207/c534950c4a79ea20293e483fd4ed4aff.jpg"
                            title="" class="jqzoom" style="outline-style: none; text-decoration: none;">
                                <div class="zoomPad" >
                        ...
                        <dt class="goods-info-head">
                            <dl>
                                ...
                                <dd id="goodsDetailBtnBox" class="goods-info-head-cart">
                                    ...
                                    <input type="hidden" id="goods_id" name="goods_id" value="2">
                                    <input type="hidden" id="class_id" name="class_id" value="6">
                                    ...
                                    <button type="button" title="收藏商品" gid="{{$rs->id}}" id='add_balance' class="btn btn-dake  goods-collect-btn">
                                        <i class="iconfont">
                                            收藏
                                        </i>
                                    </button>
