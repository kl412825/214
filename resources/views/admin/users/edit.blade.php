...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/admin/users/{{$rs->id}}" method="post" enctype="multipart/form-data">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item" >
                        <input type="text" class="small" name="username" value="{{$rs->username}}" style="width:300px;" disabled>
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">
				...
				<div class="mws-form-row">
                    ...
                    <div class="mws-form-item clearfix">
                        <ul class="mws-form-list inline">
                            ...
                            <li>
                                <label>
                                	<input type="radio" name="ustatus" value="0" @if($rs->status==0)
                                  	checked @endif> 禁用
                                </label>
                            </li>
                        </ul>
