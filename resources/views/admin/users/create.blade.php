            ...
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item" >
                        <input type="text" class="small" name="username" style="width:300px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red">用户名数字母下划线组成6-12位，必须以字母开头</span>
                    </div>
                </div>
                <div class="mws-form-row" >
                    <label class="mws-form-label">
				...
				<div class="mws-form-row">
                    ...
                    <div class="mws-form-item clearfix">
                        <ul class="mws-form-list inline">
                            <li>
                                <label>
                                  	<input type="radio" name="ustatus" value="1" checked >                           
                                    正常
                                </label>
                            </li>
                            <li>
                                <label>
                                	<input type="radio" name="ustatus" value="0" > 禁用
                                </label>
                            </li>
                        </ul>
                    </div> 
