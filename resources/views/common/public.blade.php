...
<div class="site-header">
    <div class="container">
        <div class="site-logo"> <a href="/"><img src="/ad/picture/logo.gif" style="height: 90px;"></a></div>
        <div class="header-info">
            ...
            <div class="cart-section">
                <a href="/user/cart" class="mini-cart" id="J_miniCart"><i class="iconfont"></i>购物车&nbsp;
...
<div class="site-footer">
        ...
        <div>
            ...
            @endphp
            @foreach($res as $k => $v)
            <li style="float:left;margin-right:30px"><a href="{{$v->furl}}" style="color:white">{{$v->fname}}</a></li>
            @endforeach
